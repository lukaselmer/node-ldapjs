...
function SearchEntryInternal (options) {
  options = options || {}
...
util.inherits(SearchEntryInternal, LDAPMessage)
Object.defineProperties(SearchEntryInternal.prototype, {
  type: {
...
SearchEntryInternal.prototype.addAttribute = function (attr) {
  if (!attr || typeof (attr) !== 'object') { throw new TypeError('attr (attribute) required') }

  this.attributes.push(attr)
}

SearchEntryInternal.prototype.toObject = function () {
  return this.object
}

SearchEntryInternal.prototype.fromObject = function (obj) {
...
SearchEntryInternal.prototype.setAttributes = function (obj) {
  if (typeof (obj) !== 'object') { throw new TypeError('object required') }
...
SearchEntryInternal.prototype._json = function (j) {
  assert.ok(j)
...
SearchEntryInternal.prototype._parse = function (ber) {
  assert.ok(ber)
...
SearchEntryInternal.prototype._toBer = function (ber) {
  assert.ok(ber)
...
module.exports = SearchEntryInternal
